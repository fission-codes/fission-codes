...
const IndexPage = () => (
    <div>
        <h1>"The HTTP Layer for Smart Contracts"</h1>

        <p>The <a href="https://eips.ethereum.org/EIPS/eip-1066">EIP for status codes</a> can be found on the Ethereum Improvement Proposals site.</p>
    ...
    <h3 id="humanreadable">Human Readable</h3>
